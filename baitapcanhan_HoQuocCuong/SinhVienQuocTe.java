...
public class SinhVienQuocTe extends SinhVien {
    ...
    public String toString() {
        return super.toString() + ", Loai: QuocTe, QuocTich: " + quocTich + 
               ", ChungChi: " + chungChiNgoaiNgu + ", DiemChuyenNghanh: " + String.format("%.1f", diemChuyenNghanh);
    }
    
    @Override
    public double TinhDiemTrungBinh() {
        // Gọi phương thức của lớp cha để tính điểm TB học phần
        double diemTBHocPhan = super.TinhDiemTrungBinh();
        
        // Nếu chưa có điểm học phần nào, trả về 0
        if (diemTBHocPhan == 0) {
            return 0;
        }
        
        // Tính điểm TB theo công thức đặc biệt cho sinh viên quốc tế
    ...
    public double getDiemChuyenNghanh() {
        return diemChuyenNghanh;
    }
    
    public void setDiemChuyênNghanh(double diemChuyenNghanh) {
        this.diemChuyenNghanh = diemChuyenNghanh;
    }
}